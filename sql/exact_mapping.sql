select distinct route_clean, dose_form_clean, count(*) as teller
from faers.drug_mapping_exact
group by route_clean, dose_form_clean
...
-- name: create_table
CREATE TABLE faers.drug_mapping_exact_1 AS
